<x-app-layout>
<x-slot name="title">Chat Với Cửa Hàng - Lumiere</x-slot>
<div class="max-w-4xl mx-auto px-4 py-8">
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden flex flex-col h-[600px]">
        ...
        <div class="px-6 py-4 border-b border-gray-100 bg-[#FDFBF7] flex items-center gap-3">
            <div class="w-10 h-10 rounded-full bg-[#61715B] text-white flex items-center justify-center font-bold">
                L
            </div>
            <div>
                <h3 class="font-bold text-gray-900">Lumiere Store</h3>
        ...
        <div class="px-6 py-4 bg-white border-t border-gray-100">
            <form id="chat-form" class="flex gap-2">
                ...
                <button type="submit" class="bg-black hover:bg-gray-800 text-white px-6 py-3 rounded-xl font-medium transition-colors flex items-center gap-2 disabled:opacity-50" id="send-btn">
                    Gửi
    ...
    function renderMessage(msg) {
        ...
        if (isMine) {
            ...
            <div class="flex justify-start gap-2">
                <div class="w-8 h-8 rounded-full bg-[#e8f0e8] text-[#61715B] flex items-center justify-center font-bold text-xs shadow-sm flex-shrink-0">
                    L
                </div>
