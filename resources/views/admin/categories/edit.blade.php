<x-admin-layout>
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8 flex items-center space-x-4">
            <a href="{{ route('admin.categories.index') }}" class="w-10 h-10 bg-white rounded-xl flex items-center justify-center text-gray-400 hover:text-emerald-600 transition-all border border-gray-100 shadow-sm">
            ...
            <form action="{{ route('admin.categories.update', $category) }}" method="POST" class="p-8">
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="slug" id="slug" value="{{ old('slug', $category->slug) }}" required
                                class="w-full bg-gray-50 border-gray-100 rounded-xl text-sm text-gray-900 focus:ring-emerald-500 focus:border-emerald-500 p-3 transition-all"
                                placeholder="Ví dụ: quan-jean-nam">
                    ...
                    <div>
                        ...
                        <input type="text" name="image_url" id="image_url" value="{{ old('image_url', $category->image_url) }}"
                            class="w-full bg-gray-50 border-gray-100 rounded-xl text-sm text-gray-900 focus:ring-emerald-500 focus:border-emerald-500 p-3 transition-all"
                            placeholder="https://example.com/image.jpg">
                        @if($category->image_url)
                            <div class="mt-2 group relative w-20 h-20">
                                <img src="{{ $category->image_url }}" alt="Preview" class="w-20 h-20 object-cover rounded-xl border border-gray-100 shadow-sm">
                            </div>
                        @endif
