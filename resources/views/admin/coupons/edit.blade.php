<x-admin-layout>
    <div class="max-w-3xl mx-auto">
        ...
        <div class="mb-8 flex items-center space-x-4">
            ...
            <h1 class="text-2xl font-bold text-gray-900">Chỉnh sửa mã giảm giá</h1>
        </div>

        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
            <form action="{{ route('admin.coupons.update', $coupon) }}" method="POST" class="p-8">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="type" id="type" required
                                class="w-full bg-gray-50 border-gray-100 rounded-xl text-sm text-gray-900 focus:ring-emerald-500 focus:border-emerald-500 p-3 transition-all">
                                <option value="percent" {{ old('type', $coupon->type) == 'percent' ? 'selected' : '' }}>Theo phần trăm (%)</option>
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="value" id="value" value="{{ old('value', $coupon->value) }}" required
                                class="w-full bg-gray-50 border-gray-100 rounded-xl text-sm text-gray-900 focus:ring-emerald-500 focus:border-emerald-500 p-3 transition-all"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" step="0.01" name="min_order_amount" id="min_order_amount" value="{{ old('min_order_amount', $coupon->min_order_amount) }}" required
                                class="w-full bg-gray-50 border-gray-100 rounded-xl text-sm text-gray-900 focus:ring-emerald-500 focus:border-emerald-500 p-3 transition-all">
                        ...
                        <div>
                            ...
                            <input type="number" step="0.01" name="max_discount_amount" id="max_discount_amount" value="{{ old('max_discount_amount', $coupon->max_discount_amount) }}"
                                class="w-full bg-gray-50 border-gray-100 rounded-xl text-sm text-gray-900 focus:ring-emerald-500 focus:border-emerald-500 p-3 transition-all"
