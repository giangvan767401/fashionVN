                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div class="space-y-2">
                                ...
                                <textarea name="short_desc" id="short_desc" rows="3" 
                                          ...
                                          placeholder="Tóm tắt ngắn gọn sản phẩm...">{{ old('short_desc', $product->short_desc) }}</textarea>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="description" id="description" rows="3" 
                                          class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#24422e]/10 focus:border-[#24422e] transition-all placeholder:text-gray-400"
                                          placeholder="Mô tả chi tiết kiểu dáng, cổ áo, tà áo...">{{ old('description', $product->description) }}</textarea>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="fit_guide" id="fit_guide" rows="3" 
                                          class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#24422e]/10 focus:border-[#24422e] transition-all placeholder:text-gray-400"
                                          placeholder="Ví dụ: Phom dáng thể thao thoải mái. Người mẫu cao 1m70 mặc size S...">{{ old('fit_guide', $product->fit_guide) }}</textarea>
                            ...
                            <div class="space-y-2">
                                ...
                                <textarea name="materials" id="materials" rows="3" 
                                          class="w-full bg-gray-50 border-gray-100 rounded-xl px-4 py-3 text-sm focus:ring-2 focus:ring-[#24422e]/10 focus:border-[#24422e] transition-all placeholder:text-gray-400"
                                          placeholder="Ví dụ: 100% Cotton hữu cơ, co giãn tốt...">{{ old('materials', $product->materials) }}</textarea>
