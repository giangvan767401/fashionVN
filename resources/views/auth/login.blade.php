                ...
                <div class="w-full max-w-[420px]">
                    ...
                    <div class="mt-8 text-center text-gray-500">
                        ...
                        <div class="flex items-center justify-center gap-6">
                            ...
                            <a href="{{ route('social.redirect', 'google') }}" class="w-10 h-10 flex items-center justify-center hover:opacity-80 transition" title="Đăng nhập Google">
                                <img src="{{ asset('user/img/Gmail.svg') }}" class="w-8 h-8">
                            </a>
                            <a href="{{ route('social.redirect', 'facebook') }}" class="w-10 h-10 flex items-center justify-center hover:opacity-80 transition" title="Đăng nhập Facebook">
                    ...
                    <div class="mt-8 text-center text-[11px] text-gray-500 leading-relaxed">
                        {{ __('Khi Đăng Nhập, Bạn Đồng Ý Với') }} 
