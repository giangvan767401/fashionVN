        ...
        <div class="flex-1 overflow-y-auto px-4 py-4">
            ...
            <div class="mb-4">
                ...
                <nav class="space-y-1">
                    ...
                    <a href="{{ route('admin.coupons.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.coupons.*') ? 'sidebar-item-active text-[#10b981]' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M15 5v2m0 4v2m0 4v2M5 5a2 2 0 0 0-2 2v3a2 2 0 0 1 0 4v3a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-3a2 2 0 0 1 0-4V7a2 2 0 0 0-2-2H5z"/></svg>
                        <span class="text-sm font-medium">Voucher / Khuyến mãi</span>
                    </a>
                    <a href="{{ route('admin.chat.index') }}" class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all {{ request()->routeIs('admin.chat.*') ? 'sidebar-item-active text-[#10b981]' : 'text-gray-400 hover:text-white hover:bg-white/5' }}">
