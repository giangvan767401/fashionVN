...
<body class="antialiased min-h-screen flex flex-col pt-16">
    ...
    <header class="fixed top-0 left-0 right-0 h-16 bg-[#FDFBF7] shadow-sm z-50 flex items-center justify-between px-8">
        ...
        <div class="flex items-center space-x-6 flex-1 justify-end">
            ...
            <a href="{{ route('chat.index') }}" aria-label="Chat" class="hover:text-gray-600 relative flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg>
                {{-- Uncomment next line if you want to implement unread badge for chat later --}}
                {{-- <span class="absolute -top-1 -right-1 bg-red-500 text-white text-[10px] font-bold min-w-[16px] h-[16px] rounded-full flex items-center justify-center px-1" style="line-height:1;">1</span> --}}
            </a>
