...
<head>
    ...
    <title>Lumiere - Women Clothing</title>
    <!-- Fonts -->
...
<body class="antialiased">
    <div class="min-h-screen bg-white">
        <!-- Top Bar -->
        <div class="bg-[#4A5D45] text-white py-2 text-center text-sm font-medium tracking-wide">
                ...
                <div class="flex justify-between items-center h-20">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ url('/') }}" class="flex flex-col items-center">
                            <span class="text-2xl font-bold tracking-tighter text-[#1A1A1A]">Lumiere<span class="text-[#4A5D45]">.</span></span>
                            <span class="text-[10px] uppercase tracking-[0.2em] text-gray-500 -mt-1">women clothing</span>
                        </a>
                    </div>
