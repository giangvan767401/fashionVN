...
<head>
    ...
    <style>
        body { font-family: 'Montserrat', sans-serif; background: #fdfdfc; }
    </style>
</head>
<body class="min-h-screen flex items-center justify-center p-6">
    ...
    <div class="max-w-xl w-full bg-white p-10 md:p-14 text-center" style="border: 1px solid #eaeaea; box-shadow: 0 4px 24px rgba(0,0,0,0.02);">
        ...
        <div class="mx-auto w-16 h-16 rounded-full flex items-center justify-center mb-6" style="background: #eef2eb;">
            <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="#6b8c5e" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
        </div>
